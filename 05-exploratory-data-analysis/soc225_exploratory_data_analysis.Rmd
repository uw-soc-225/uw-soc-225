...
schools %>% # take our modified data
  ggplot(aes(x = `Percent of Students Chronically Absent`, # assign the x and y aesthetics
...
4.2 These will be bar plots if your data is categorical, histograms if it's continuous. If the data is categorical but has lots of different values, you should consider combining it using factors.
