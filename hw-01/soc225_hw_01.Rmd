...
1.2 Read the airbnb file: data/listings.csv

You'll need to add this file to your project in the appropriate folder. You can get it from module 2 or module 3. 
